...
class Dataset(object):
    ...
    def __loadData__(self, pop_num, label_loc, div_mode, test_size):
        """
...
class Worker(object):
    ...
    def getData(self):
        ...
        trainX = trainX_[self.pop]
        testX = testX_[self.pop]
        trainy = trainy_[self.pop]
        testy = testy_[self.pop]
    ...
    def is_better_pop(self, fit, fea):
        ...
        if fit > Global_fit:
            ...
            print(self.name, '  ', self.my_max_fea)
            print(self.name, '  ', fea)
    ...
    def get_fit_nflod(self, feature_Selected1, feature_Selected2, feature_Selected3, feature_Selected4):
        ...
        trainX_, testX_, trainy_, testy_ = self.getData()
...
if __name__ == '__main__':
    with tf.Graph().as_default(), tf.device('/cpu:0'):
        ...
        numset = 10
        N_knn = 1
        data = Dataset('E:/dataset/glass', SPLIT)
        data.__loadData__(N_WORKERS, 1, ',', 0.3)
        data.__getData__()
