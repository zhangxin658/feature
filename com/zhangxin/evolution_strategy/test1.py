...
# # import numpy as np
# # class MyDemo(object):
# #     def __init__(self, name, globalDemo = None):
# #         if name == 'global':
# #             self.age = 20
# #         else:
# #             self.age = 10
...
# #         mydemo = MyDemo(name, globaldemo)
# #
# # if __name__ == "__main__":
# #     globaldemo = MyDemo('global')
# #     test = Test('zhangxin')
# #     print(globaldemo.age)
#
# #
...
from pandas import *
from random import *
# n1 = np.mat([i for i in range(len(open('E:/wine.txt').readline().split(',')))])
data = pd.read_csv('E:/wine.ch.txt', sep=' ')# 生成空的pandas表
print(data)
# n = np.vstack((n1, n2))
# data.loc[0] = [i for i in range(len(open('E:/wine.txt').readline().split(',')))]
val = pymrmr.mRMR(data, 'MIQ', 8)
print(val)

# data = pd.read_csv('E:/wine.txt', sep=',')
